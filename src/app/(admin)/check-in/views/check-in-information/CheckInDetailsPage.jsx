...
const tabs = [
  ...
  { key: 'repairApproval', label: 'Repair & Approval', icon: 'noto:person-gesturing-ok', component: RepairApprovalPage },
  { key: 'utilityReadings', label: 'Utility Readings', icon: 'ri:calendar-line', component: UtilityReadingsPage },
  { key: 'agreement', label: 'Agreement', icon: 'ri:checkbox-circle-fill', component: AgreementPage },
